            ...
            <div className="relative -mt-12 flex justify-center px-4">
                <div className="w-full max-w-sm bg-white/90 backdrop-blur-md rounded-2xl shadow-xl p-8 space-y-6 border border-gray-100">
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <Button className="w-full py-6 rounded-xl text-base" type="submit" disabled={loading}>
                        ...
                        <p className="text-center text-sm text-gray-600 pt-4">
                            ...
                            <Button variant={'ghost'} onClick={() => router.push('/signup')} className="w-full py-2 rounded-xl text-base mt-4" type="button">
                                Sign Up
                            </Button>
                        </p>
                    </form>
